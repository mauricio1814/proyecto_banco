        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="segundo_apellido" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');" name="segundo_apellido"  placeholder="Segundo Apellido" value="<?php echo $row['segundo_apellido']; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="celular" class="col-sm-2 control-label">Telefono</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="telefono" name="telefono" oninput="this.value = this.value.replace(/[^0-9]/g, '');" placeholder="Telefono" value="<?php echo $row['celular']; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" id="contraseña" name="contraseña" placeholder="Contraseña" value="<?php echo $row['contrasena']; ?>" required>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="Cliente.php" class="btn btn-default">Regresar</a>
